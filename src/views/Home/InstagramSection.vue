<template>
     <section class=" mt-40 lg:mt-44 lg:my-20 my-8 ">
        <div class="container px-5 font-Morabba">
            <div
                class="flex flex-col  relative items-center justify-end xl:py-12 pb-12 pt-24 sm:px-16 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-3xl">
                <img class="absolute scale-75 right-1/2 transform  translate-x-1/2    sm:-top-28 -top-24"
                    src="/images/index_instagram_phone.png" alt="">
                <h6 class=" md:text-2xl text-lg text-white font-extrabold  mb-5  sm:mt-8  text-center">
                    ما هر روز کلی مطالب آموزشی جالب در اینستاگراممون منتشر می‌کنیم!</h6>
                <a class=" px-5 py-3 flex items-center font-bold xl:text-15 sm:text-xs text-10 bg-white rounded-3xl text-purple-600  transition duration-200 hover:text-white hover:bg-purple-600 border hover:border-1 border-white whitespace-nowrap"
                    href="#">
                    مشاهده صفحه اینستاکرام
